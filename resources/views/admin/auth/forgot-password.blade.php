            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('admin.password.email') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" name="email" class="form-control" placeholder="Input your email..." value="{{ old('email') }}" required>
                        <x-input-error :message="$errors->first('email')" class="mt-2" />
                    </div>

                    <div class="form-footer">
                        <button type="submit" class="btn btn-primary w-100">{{ __('Reset Password Link') }}</button>
                    </div>
                </form>
            </div>
        </div>
